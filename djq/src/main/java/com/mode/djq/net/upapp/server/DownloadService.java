package com.mode.djq.net.upapp.server;
...
import com.mode.djq.R;
import com.mode.djq.net.upapp.config.UpdateConfiguration;
import com.mode.djq.net.upapp.listener.OnDownloadListener;
import com.mode.djq.net.upapp.manage.DownloadManager;
import com.mode.djq.net.upapp.manage.HttpDownloadManager;
import com.mode.djq.net.upapp.upapp.BaseHttpDownloadManager;
import com.mode.djq.net.utils.ApkUtil;
import com.mode.djq.net.utils.Constant;
import com.mode.djq.net.utils.FileUtil;
import com.mode.djq.net.utils.HttpUtil;
import com.mode.djq.net.utils.LogUtil;
import com.mode.djq.net.utils.NotificationUtil;
